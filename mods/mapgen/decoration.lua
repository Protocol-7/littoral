...
minetest.register_decoration({
    ...
    noise_params = {
        offset = 0,
        scale = (org.abundance and org.abundance/10) or (org.form == "seagrass" and 0.008) or 0.04,
        spread = {x = 1000, y = 100, z = 1000},
        seed = 354,
        octaves = 1,
        persist = 0.4,
        lacunarity = 2.0,
    ...
    param2 = (org.paramtypes[2] == "meshoptions" and 4) or org.form == "seagrass" and 16 or 0,
    -- Param2 value of decoration nodes.
    -- If param2_max is not 0, this is the lower limit of a randomly
    -- selected param2.

    param2_max = org.form == "seagrass" and 16*9 or 4,
