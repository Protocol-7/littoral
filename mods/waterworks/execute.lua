...
local valid_sink = function(node_name)
	return node_name == "air" or node_name == "littoral_mapgen:water_flowing"
end
local valid_source = function(node_name)
	return node_name == "littoral_mapgen:water_source"
end
		...
		if source.pressure + pressure_margin >= sink.pressure then 
			...
			if source_pos ~= nil then
				...
				if sink_pos ~= nil then
					minetest.swap_node(sink_pos, {name="littoral_mapgen:water_source"})
